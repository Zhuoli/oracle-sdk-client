...
def collect_oke_instances(
    client: OCIClient, compartment_id: str, region: str
) -> List[InstanceInfo]:
    """
...
def collect_all_resources(
    client: OCIClient, compartment_id: str, region: str
) -> tuple[List[InstanceInfo], List[InstanceInfo], List[BastionInfo]]:
    """
