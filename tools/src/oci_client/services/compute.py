...
class ComputeService:
    ...
    def __init__(
        self, compute_client: oci.core.ComputeClient, network_client: oci.core.VirtualNetworkClient
    ):
        ...
        try:
            ...
            return {
                ...
                "shape_config": {
                    ...
                    "memory_in_gbs": (
                        instance.shape_config.memory_in_gbs if instance.shape_config else None
                    ),
                },
                "availability_domain": instance.availability_domain,
    ...
    def start_instance(self, instance_id: str) -> bool:
        ...
        try:
            self.compute_client.instance_action(instance_id=instance_id, action="START")
    ...
    def stop_instance(self, instance_id: str, force: bool = False) -> bool:
        ...
        try:
            ...
            self.compute_client.instance_action(instance_id=instance_id, action=action)
    ...
    def create_instance_console_connection(
        self, instance_id: str, public_key: str
    ) -> Dict[str, Any]:
