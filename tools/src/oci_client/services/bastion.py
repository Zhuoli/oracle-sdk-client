...
from ..models import BastionInfo, BastionType, LifecycleState, SessionInfo
        ...
        try:
            ...
            while response.data:
                ...
                if response.has_next_page:
                    response = self.bastion_client.list_bastions(**kwargs, page=response.next_page)
                else:
                    break
    ...
    def list_sessions(
        ...
        try:
            ...
            while response.data:
                ...
                if response.has_next_page:
                    response = self.bastion_client.list_sessions(**kwargs, page=response.next_page)
                else:
                    break
