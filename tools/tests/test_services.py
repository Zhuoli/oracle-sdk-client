...
class TestComputeService:
    ...
    def test_get_instance(self, compute_service):
        ...
        compute_service.compute_client.list_boot_volume_attachments.return_value.data = [
            mock_boot_attachment
        ]
    ...
    def test_start_instance(self, compute_service):
        ...
        compute_service.compute_client.instance_action.assert_called_once_with(
            instance_id="ocid1.instance.oc1..xxxxx", action="START"
        )
    ...
    def test_stop_instance(self, compute_service):
        ...
        assert result is True
        compute_service.compute_client.instance_action.assert_called_once_with(
            instance_id="ocid1.instance.oc1..xxxxx", action="STOP"
        )
    ...
    def test_reboot_instance(self, compute_service):
        ...
        assert result is True
        compute_service.compute_client.instance_action.assert_called_once_with(
            instance_id="ocid1.instance.oc1..xxxxx", action="RESET"
        )
...
class TestIdentityService:
    ...
    def test_list_regions(self, identity_service):
        ...
        identity_service.identity_client.list_regions.return_value.data = [
            mock_region1,
            mock_region2,
        ]
    ...
    def test_list_availability_domains(self, identity_service):
        ...
        identity_service.identity_client.list_availability_domains.return_value.data = [
            mock_ad1,
            mock_ad2,
        ]
    ...
    def test_list_compartments(self, identity_service):
        ...
        compartments = identity_service.list_compartments(
            compartment_id="ocid1.compartment.oc1..parent", lifecycle_state=LifecycleState.ACTIVE
        )
...
class TestBastionService:
    ...
    def test_list_bastions(self, bastion_service):
        ...
        bastions = bastion_service.list_bastions(
            compartment_id="ocid1.compartment.oc1..xxxxx", bastion_type=BastionType.STANDARD
        )
    ...
    def test_delete_bastion(self, bastion_service):
        ...
        assert result is True
        bastion_service.bastion_client.delete_bastion.assert_called_once_with(
            "ocid1.bastion.oc1..xxxxx"
        )
    ...
    def test_create_session_with_existing_key(self, mock_path, mock_open, bastion_service):
        ...
        bastion_service.bastion_client.create_session.return_value.data.id = (
            "ocid1.bastionsession.oc1..xxxxx"
        )
    ...
    def test_list_sessions(self, bastion_service):
        ...
        sessions = bastion_service.list_sessions(
            bastion_id="ocid1.bastion.oc1..xxxxx", lifecycle_state=LifecycleState.ACTIVE
        )
    ...
    def test_delete_session(self, bastion_service):
        ...
        assert result is True
        bastion_service.bastion_client.delete_session.assert_called_once_with(
            "ocid1.bastionsession.oc1..xxxxx"
        )
    ...
    def test_get_ssh_command(self, bastion_service):
        ...
        session.ssh_metadata = {"username": "ubuntu", "proxy_command": "nc proxy 22"}
